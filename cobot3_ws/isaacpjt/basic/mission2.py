...
cube_green_prim = DynamicCuboid(                              # 4. Prim
...
cube_blue_prim = DynamicCuboid(                              # 4. Prim
...
world.scene.add(cube_red_prim)
world.scene.add(cube_green_prim)
world.scene.add(cube_blue_prim)
