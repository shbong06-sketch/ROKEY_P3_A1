# guidance2_21차 — 주행·도킹·Place 전 구간 (고피에서 지시, 내피에서 Nav2)

- 작성일: 2026-09-23, 브랜치 `feature/Inspection-Place-nav2`. Isaac 실행을 다시 `isaac_python` 으로 되돌린 판이며 20차는 `guidance/past/` 로 옮김.
