# guidance2_25차 — 주행·도킹·Place 전 구간 (고피에서 지시, 내피에서 Nav2)

- 작성일: 2026-09-24, 브랜치 `feature/Inspection-Place-nav2`. 24차에서 후진 도착 방향이 21도 틀어지고 Isaac 이 종료된 원인을 고친 판이며 24차는 `guidance/past/` 로 옮김. **Isaac 을 못 쓰는 동안 내피 모의로만 검증했다(ADR 2.7: 모의 통과 ≠ 실측 통과).**
