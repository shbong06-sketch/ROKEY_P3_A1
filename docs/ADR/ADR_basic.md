...
```
- **ROS 버전**: ROS2 Jazzy
- **실측 PC**: 고피1(ROS_DOMAIN_ID=101, 10.10.0.2)과 고피2(ROS_DOMAIN_ID=102, 유선 IP 10.10.0.1)를 번갈아 사용함. 내피 유선 IP 10.10.0.3. 세 PC 모두 `~/.ros/fastdds_whitelist.xml` 에 127.0.0.1 과 10.10.0.1~4 가 있어야 함.
